...
export function BentoExperiences() {
  return (
    <motion.div 
      ...
      className="col-span-2 lg:col-span-2 row-span-1 bg-zinc-900/50 rounded-3xl border border-white/10 p-6 flex flex-col justify-between shadow-2xl overflow-hidden relative group order-3 lg:order-2"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 h-full items-end mt-4 z-10">
        ...
        <div className="flex flex-col gap-2 border-y sm:border-y-0 sm:border-x border-white/5 py-4 sm:py-0 sm:px-6">
          <h3 className="text-[10px] font-bold uppercase tracking-widest text-white/90">University</h3>
          <p className="text-[11px] text-white/40 leading-relaxed line-clamp-2">Pursuing Computer Science at UFSC.</p>
        </div>
        <div className="flex flex-col gap-2 sm:col-span-2 md:col-span-1">
          <h3 className="text-[10px] font-bold uppercase tracking-widest text-white/90">Experience</h3>
          <p className="text-[11px] text-white/40 leading-relaxed line-clamp-2">Building high-performance web systems.</p>
        </div>
      </div>
    </motion.div>
  );
