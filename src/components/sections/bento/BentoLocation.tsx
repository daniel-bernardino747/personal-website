...
export function BentoLocation() {
  return (
    <motion.div 
      ...
      className="col-span-1 row-span-1 bg-zinc-900/50 rounded-3xl border border-white/10 p-6 flex flex-col justify-end relative overflow-hidden shadow-2xl group order-5 lg:col-start-2 lg:row-start-3"
    >
      ...
      <div className="relative z-10">
        <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tighter leading-none mb-1">
          ...
          <span className="block text-white/60 text-base font-medium tracking-normal mt-0.5">{profile.location.split(",")[1]}</span>
        </h3>
        <div className="flex items-center gap-2 mt-2">
           <span className="text-[8px] font-mono text-white/30 uppercase tracking-widest">50.06° N, 19.94° E</span>
